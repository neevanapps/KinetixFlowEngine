    ...
    public class FlowMetricsRecorder
    {
        ...
        private void WriteHeader()
        {
            var header = "timestamp,price,score,score_z,velocity_z,imbalance_z,compression_z,exhaustion_z," +
                    ...
                    "vwap_bullish_absorption,vwap_bearish_absorption,whale_buy_trades,whale_sell_trades,impact_efficiency,bullish_control,bearish_control,prob_fast,prob_Medium,prob_slow,long_persist,short_persist";
        ...
        public void Record(KinetixEngineResult r)
        {
            var line = string.Join(",",
                ...
                r.LongPersistence,
                r.ShortPersistence,
                r.Volume.ToString(CultureInfo.InvariantCulture)
            );
