...
namespace KinetixFlowEngine.Core.Strategy.Strategies
{
    public class MediumProbStrategy : IKinetixStrategy
    {
        ...
        {
            if ((decimal)r.ProbMediumEma > r.EmaStability.ProbMediumEmaLevel1 && r.EmaStability.ProbMediumEmaLevel1 > r.EmaStability.ProbMediumEmaLevel2
                        && r.EmaStability.ProbMediumEmaLevel2 > r.EmaStability.ProbMediumEmaLevel3)
            {
