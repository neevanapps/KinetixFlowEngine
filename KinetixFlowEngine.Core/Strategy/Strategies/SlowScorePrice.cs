...
{
    public class SlowScorePrice : IKinetixStrategy
    {
        public string Name => "SlowPrice";
        private readonly StrategyConfig _config;
        public SlowScorePrice(StrategyConfigLoader loader)
        {
        ...
        public StrategySignal EvaluateEntry(KinetixEngineResult r)
        {
            ...
            bool bullish = l1 > l2 && l2 > l3 && spread > 0.5m && l1 > .2m;
            bool bearish = l1 < l2 && l2 < l3 && -spread > 0.5m && l1 < -.2m;
