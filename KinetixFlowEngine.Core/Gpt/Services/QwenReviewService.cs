...
namespace KinetixFlowEngine.Core.Gpt.Services
{
    public sealed class QwenReviewService : IModelReviewer
    {
        ...
        private readonly ILogger<QwenReviewService> _logger;
        private const string ModelName = "qwen3-14b-trading";
